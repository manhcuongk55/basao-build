      ...
      <div className="pt-20">
        ...
        <section className="relative px-6 py-24 text-center max-w-5xl mx-auto">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              Nhập thông số dự án → AI báo giá tự động → Đặt hàng từ nhà máy VN &amp; kho TQ → Giao thẳng tới công trình. Không qua trung gian.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto">
              {[
                ...
                { v: cnSuppliers + "+", l: "Kho TQ nhập trực tiếp" },
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              { step: "02", icon: "🤖", title: "AI báo giá", desc: "Tự động chọn nhà cung cấp tốt nhất theo ngân sách." },
        ...
        <section className="px-6 py-16 max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Vật liệu nổi bật</h2>
            <Link href="/suppliers" className="text-sm text-blue-400 hover:underline">Xem tất cả →</Link>
          </div>
